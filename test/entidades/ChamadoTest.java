...
public class ChamadoTest {
    ...
    public void testeCadastroChamadoProblemaNaRede() {
        ...
        Chamado chamado = new Chamado(1, "Título", "Descrição",1, tecnico, clienteEmpresa, "Windows", "Xp", "Cabo", "192.168.0.1");
        assertEquals(01, chamado.getCodigo());
        assertEquals("Título", chamado.getTitulo());
        assertEquals("Descrição", chamado.getDescricao());
        ...
        assertEquals("Cabo", chamado.getTipoConexao());
        assertEquals("192.168.0.1",chamado.getEnderecoRede());
    ...
    public void cadastrarChamadoProblemaBancoDeDados() {
        ...
        Empresa empresa = new Empresa(123, "Apple");
        ClienteEmpresa clienteEmpresa = new ClienteEmpresa(1, empresa, 2197534L, "Pedro", 123);
        Chamado chamadoBancoDados = new Chamado("Título", "Descrição", 2, tecnico, clienteEmpresa, "Windows", "Xp", "Oracle");
